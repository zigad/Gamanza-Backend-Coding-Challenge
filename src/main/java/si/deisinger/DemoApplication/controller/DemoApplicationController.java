package si.deisinger.DemoApplication.controller;
...
import si.deisinger.DemoApplication.service.PlayersService;
...
public class DemoApplicationController {
	 ...
	 *
	 * @param game POST request must be Content-Type: JSON
	 *             Example body:
	 *             {
	 *             "name": "Example Game",
	 ...
	 *
	 * @param id Parameter must be game ID.
	 */
